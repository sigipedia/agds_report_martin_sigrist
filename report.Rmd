...
The task for this chapter was the use of code management possibilities, provided from GitHub. This exercise was done in pairs. My team mate was Alexandre Buser (alexandre.buser@students.unibe.ch). The two repositories can be accessed with the following links:
...
The aim of this part of the course was the introduction in k-Nearest-Neighbor machine learning models and the comparision with the linear model. 
